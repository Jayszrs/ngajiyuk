...
?>
<!doctype html><html lang="id"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Masuk ke akun · NGAJI YUK!</title><link rel="icon" href="<?= url('assets/images/favicon.ico') ?>"><link rel="stylesheet" href="<?= url('assets/css/app.css') ?>"></head><body>
<div class="auth-shell"><section class="auth-visual"><a class="brand auth-brand" href="<?= url() ?>"><img src="<?= url('assets/images/logo.png') ?>" alt="Logo sekolah"><span><strong>NGAJI YUK!</strong><small>SD ISLAM LABSCHOOL BANI SALEH</small></span></a><div class="auth-message"><span class="auth-feature-icon"><?= svg_icon('book',28) ?></span><p class="eyebrow">PORTAL SEKOLAH TERINTEGRASI</p><h2>Satu catatan, satu arah perkembangan.</h2><p>Masuk untuk mengelola dan memantau perjalanan Tahsin &amp; Tahfidz siswa secara berkelanjutan.</p><div class="auth-points"><span>✓ Laporan tersusun rapi</span><span>✓ Akses sesuai peran</span><span>✓ Data terhubung</span></div></div><small>© <?= date('Y') ?> SD Islam Labschool Bani Saleh</small></section>
